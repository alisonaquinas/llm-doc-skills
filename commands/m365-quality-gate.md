...
If `pwsh` is unavailable on Windows, use `powershell -NoProfile -File skills/m365/scripts/verify-m365-install.ps1`.
...
```bash
pwsh -NoProfile -File skills/m365/scripts/collect-m365-help.ps1
